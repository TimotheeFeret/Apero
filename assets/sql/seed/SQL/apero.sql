...
--
ALTER TABLE `classe`
  ADD CONSTRAINT `fk_etablissement_classe` FOREIGN KEY (`etablissement_id`) REFERENCES `etablissement` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
